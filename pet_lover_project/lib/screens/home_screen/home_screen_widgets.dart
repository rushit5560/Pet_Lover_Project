...
import '../pet_shop_screen/pet_shop_screen.dart';
import '../set_reminder_screen/set_reminder_screen.dart';
          ...
          SizedBox(
            child: Row(
              children: [
                ...
                GestureDetector(
                  onTap: () => Get.to(()=> PetShopScreen(), transition: Transition.zoom),
                  child: Container(
                    padding: const EdgeInsets.all(5),
                    child: Image.asset(
...
class PetServicesModule extends StatelessWidget {
  ...
  Widget _seeMoreModule() {
    return GestureDetector(
      onTap: () => Get.to(()=> NearByPetServicesScreen(), transition: Transition.zoom),
      child: Container(
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: GestureDetector(
        onTap: () => Get.to(()=> const SetReminderScreen(), transition: Transition.zoom),
        child: Container(
          width: Get.width,
          height: 110,
          decoration: BoxDecoration(
                ...
                child: PageView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: GestureDetector(
                        onTap: () => Get.to(()=> PetMatchScreen(), transition: Transition.zoom),
                        child: Column(
                          children: [
                            Expanded(
                              flex: 80,
